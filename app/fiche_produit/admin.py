...
admin.site.register(Annexe5)
admin.site.register(Department)
admin.site.register(FPType)
admin.site.register(ProductCard)
admin.site.register(PackageType)
admin.site.register(ProductCardAnnexe5)
admin.site.register(ProductCardRoom)
admin.site.register(Order)
admin.site.register(OrderItem)
admin.site.register(Facture)
admin.site.register(FactureItem)
admin.site.register(Routage)
admin.site.register(RoutageItem)
