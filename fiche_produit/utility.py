...
def fp_excel_works(**kwargs):
    ...
    # fp_cells={}
    # fp_cells['product_name_fr'] = sh['G2']
    # fp_cells['product_name_ru'] = sh['G3']
    # fp_cells['product_desc_fr'] = sh['A11']
    # fp_cells['product_desc_ru'] = sh['M11']

    # for cl in fp_cells:
    # print(data_dict.get(cl), 'will be written to',fp_cells[cl])
